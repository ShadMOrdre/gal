...
gal.lib.csv.load_worldpath = dofile(gal.lib.csv.path .. "/lib_csv_load_worldpath.lua")

--gal.lib.csv.save_worldpath = dofile(gal.lib.csv.path .. "/lib_csv_save_worldpath.lua")
dofile(gal.lib.csv.path .. "/lib_csv_save_worldpath.lua")

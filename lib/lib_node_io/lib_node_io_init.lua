...
if minetest.global_exists("default") then
	dofile(MP.."/lib_node_io_support_default.lua")
end

if minetest.global_exists("gal") and minetest.global_exists("lib_chests") and minetest.global_exists("lib_forge") then
	dofile(MP.."/lib_node_io_support_gal.lua")
end

...
gal.lib.shapes.register_fence_set = function(node_mat)
	...
	gal.lib.shapes.register_fence_node(node_mat, "handrail")
	gal.lib.shapes.register_fence_node(node_mat, "handrail_stairs")
	gal.lib.shapes.register_fence_node(node_mat, "handrail_stairs_left")
	gal.lib.shapes.register_fence_node(node_mat, "handrail_stairs_right")
	gal.lib.shapes.register_fence_node(node_mat, "handrail_post")

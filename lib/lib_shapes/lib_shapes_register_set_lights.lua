...
gal.lib.shapes.register_chandelier_01 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name, {
	gal.lib.node.register_to_game(wall_name, {
...
gal.lib.shapes.register_lamp_01 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name, {
	gal.lib.node.register_to_game(wall_name, {
		description = wall_desc,
...
gal.lib.shapes.register_lamp_02 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name .. "_off", {
	gal.lib.node.register_to_game(wall_name .. "_off", {
		description = wall_desc,
		drawtype = "nodebox",
		tiles = {
	...
	gal.lib.node.register_to_game(wall_name .. "_on", {
		description = wall_desc,
		drawtype = "nodebox",
		tiles = {
...
gal.lib.shapes.register_lamp_03 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name .. "_off", {
	gal.lib.node.register_to_game(wall_name .. "_off", {
		description = wall_desc,
		drawtype = "nodebox",
		tiles = {
			"(window_glass_overlay.png^wool_dark_grey.png^window_glass_overlay.png^[makealpha:255,126,126)^(overlay_fence_top_post.png^" .. wall_texture .. "^overlay_fence_top_post.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
			"(window_glass_overlay.png^wool_dark_grey.png^window_glass_overlay.png^[makealpha:255,126,126)^(overlay_fence_top_post.png^" .. wall_texture .. "^overlay_fence_top_post.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
			"(overlay_alpha_light_lamp_frame.png^(overlay_alpha_chair_front_fabric2.png^wool_dark_grey.png^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^(overlay_alpha_chair_front_fabric2.png^" .. wall_texture .. "^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^overlay_alpha_light_lamp_frame.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
			"(overlay_alpha_light_lamp_frame.png^(overlay_alpha_chair_front_fabric2.png^wool_dark_grey.png^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^(overlay_alpha_chair_front_fabric2.png^" .. wall_texture .. "^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^overlay_alpha_light_lamp_frame.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
			"(overlay_alpha_light_lamp_frame.png^(overlay_alpha_chair_front_fabric2.png^wool_dark_grey.png^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^(overlay_alpha_chair_front_fabric2.png^" .. wall_texture .. "^overlay_alpha_chair_front_fabric2.png^[makealpha:255,126,126)^[transformFY^overlay_alpha_light_lamp_frame.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
	...
	gal.lib.node.register_to_game(wall_name .. "_on", {
		...
		drawtype = "nodebox",
		tiles = {
			"(window_glass_overlay.png^wool_grey.png^window_glass_overlay.png^[makealpha:255,126,126)^(overlay_fence_top_post.png^" .. wall_texture .. "^overlay_fence_top_post.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
			"(window_glass_overlay.png^wool_grey.png^window_glass_overlay.png^[makealpha:255,126,126)^(overlay_fence_top_post.png^" .. wall_texture .. "^overlay_fence_top_post.png^[makealpha:255,126,126)^(overlay_alpha_light_lamp_bulb.png^lamp_2_off.png^overlay_alpha_light_lamp_bulb.png^[makealpha:255,126,126)",
...
gal.lib.shapes.register_lamp_04 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name .. "_off", {
	gal.lib.node.register_to_game(wall_name .. "_off", {
		description = wall_desc,
...
gal.lib.shapes.register_lamp_bulb = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name, {
	gal.lib.node.register_to_game(wall_name, {
		description = wall_desc,
...
gal.lib.shapes.register_lamp_simple_01= function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name, {
	gal.lib.node.register_to_game(wall_name, {
		description = wall_desc,
...
gal.lib.shapes.register_overhead_01 = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	-- inventory node, and pole-type wall start item
	--minetest.register_node("lib_lights:" .. wall_name, {
	gal.lib.node.register_to_game(wall_name, {
		description = wall_desc,
...
function gal.lib.shapes.register_light_nodes(node_name, node_desc, node_texture, node_craft_mat, node_sounds)

--CONNECTED LINKS

	gal.lib.shapes.register_chandelier_01(node_name .. "_chandelier_01", node_desc .. "chandelier_01", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_lamp_bulb(node_name .. "_lamp_bulb", node_desc .. "lamp_bulb", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_lamp_simple_01(node_name .. "_lamp_simple_01", node_desc .. "lamp_simple_01", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_overhead_01(node_name .. "_overhead_01", node_desc .. "overhead_01", node_texture, node_craft_mat, node_sounds)


	
end

function gal.lib.shapes.register_lamp_nodes(node_name, node_desc, node_texture, node_craft_mat, node_sounds)

--CONNECTED LINKS

	gal.lib.shapes.register_lamp_01(node_name .. "_lamp_01", node_desc .. "lamp_01", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_lamp_02(node_name .. "_lamp_02", node_desc .. "lamp_02", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_lamp_03(node_name .. "_lamp_03", node_desc .. "lamp_03", node_texture, node_craft_mat, node_sounds)
	gal.lib.shapes.register_lamp_04(node_name .. "_lamp_04", node_desc .. "lamp_04", node_texture, node_craft_mat, node_sounds)
...
--
gal.lib.shapes.register_light_nodes("steelblock", "Steel ", "default_steel_block.png", "gal:metal_steel_block", gal.node_sound_metal_defaults())
gal.lib.shapes.register_light_nodes("copperblock", "Copper ", "default_copper_block.png", "gal:metal_copper_block", gal.node_sound_metal_defaults())
gal.lib.shapes.register_light_nodes("tinblock", "Tin ", "default_tin_block.png", "gal:metal_tin_block", gal.node_sound_metal_defaults())
gal.lib.shapes.register_light_nodes("bronzeblock", "Bronze ", "default_bronze_block.png", "gal:metal_bronze_block", gal.node_sound_metal_defaults())
gal.lib.shapes.register_light_nodes("goldblock", "Gold ", "default_gold_block.png", "gal:metal_gold_block", gal.node_sound_stone_defaults())
gal.lib.shapes.register_light_nodes("diamondblock", "Diamond ", "default_diamond_block.png", "gal:mineral_diamond_block", gal.node_sound_stone_defaults())

gal.lib.shapes.register_light_nodes("glass", "Glass ", "default_glass.png", "gal:glass", gal.node_sound_stone_defaults())
--

gal.lib.shapes.register_lamp_nodes("clay_baked_black", "black ", "lib_materials_clay_baked_black.png", "gal:clay_baked_black", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_blue", "blue ", "lib_materials_clay_baked_blue.png", "gal:clay_baked_blue", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_dark_green", "dark_green ", "lib_materials_clay_baked_dark_green.png", "gal:clay_baked_dark_green", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_dark_grey", "dark_grey ", "lib_materials_clay_baked_dark_grey.png", "gal:clay_baked_dark_grey", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_orange", "orange ", "lib_materials_clay_baked_orange.png", "gal:clay_baked_orange", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_red", "red ", "lib_materials_clay_baked_red.png", "gal:clay_baked_red", gal.node_sound_stone_defaults())
gal.lib.shapes.register_lamp_nodes("clay_baked_white", "white ", "lib_materials_clay_baked_white.png", "gal:clay_baked_white", gal.node_sound_stone_defaults())

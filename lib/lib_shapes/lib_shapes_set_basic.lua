...
gal.lib.shapes.register_shape("roof_corner", {
	description = S("Roof Corner"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
...
gal.lib.shapes.register_shape("steps_open", {
...
gal.lib.shapes.register_shape("steps_solid", {
...
gal.lib.shapes.register_shape("wall_arch_large", {
	description = S("wall_arch_large"), 
	shape_type = "basic",
	node_box = {
			type = "fixed",
			fixed = {
...
gal.lib.shapes.register_shape("wall_arch_small", {
	description = S("wall_arch_small"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {

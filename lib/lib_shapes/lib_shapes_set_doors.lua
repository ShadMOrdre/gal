...
gal.lib.shapes.register_shape("door_centered_jail", {
	description = S("Door (Jail) Centered"), 
	shape_type = "door",
	inv_node_box = {
		type = "fixed",
		fixed = {
	...
	node_box = {
		...
		fixed = {
			...
			{-0.5, 0.4375, -0.0625, 0.5, 0.5625, 0.0625},
			{-0.5, -0.5, -0.0625, 0.5, -0.4375, 0.0625},
			{-0.5, -0.5, -0.0625, -0.4375, 1.5, 0.0625},
			{-0.1875, -0.5, -0.0625, -0.125, 1.5, 0.0625},
			{0.125, -0.5, -0.0625, 0.1875, 1.5, 0.0625},
	...
	open_node_box = {
		type = "fixed",
		fixed = {
			{-0.5, 1.4375, 0, -0.375, 1.5, 1.0},
			{-0.5, 0.4375, 0, -0.375, 0.5625, 1.0},
			{-0.5, -0.5, 0, -0.375, -0.4375, 1.0},
			{-0.5, -0.5, 0, -0.375, 1.5, 0.0625},
			{-0.5, -0.5, 0.3175, -0.375, 1.5, 0.375},
			{-0.5, -0.5, 0.625, -0.375, 1.5, 0.6875},
			{-0.5, -0.5, 0.9375, -0.375, 1.5, 1.0},
		},
	},
	open_selection_box = {
		type = "fixed",
...
gal.lib.shapes.register_shape("door_centered_jail_right", {
	description = S("Door (Jail) Centered Right"), 
	shape_type = "door",
	inv_node_box = {
		type = "fixed",
		fixed = {
	...
	open_node_box = {
		type = "fixed",
		fixed = {
			{0.375, 1.4375, 0, 0.5, 1.5, 1.0},
			{0.375, 0.4375, 0, 0.5, 0.5625, 1.0},
			{0.375, -0.5, 0, 0.5, -0.4375, 1.0},
			{0.375, -0.5, 0, 0.5, 1.5, 0.0625},
			{0.375, -0.5, 0.3175, 0.5, 1.5, 0.375},
			{0.375, -0.5, 0.625, 0.5, 1.5, 0.6875},
			{0.375, -0.5, 0.9375, 0.5, 1.5, 1.0},
		},
	},
	open_selection_box = {
		type = "fixed",

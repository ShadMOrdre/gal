...
gal.lib.shapes.register_shape("handrail", {
	description = S("Rail"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
gal.lib.shapes.register_shape("handrail_stairs", {
	description = S("Handrail Stairs"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
			-- {-0.4375, -0.25, 0.4375, -0.375, 0.375, 0.5}, -- support1 from front --left
			...
			-- {0.0625, -0.75, 0.4375, 0.125, -0.125, 0.5}, -- support3 from front
			...
			-- {-0.4375, -0.25, -0.5, -0.375, 0.375, -0.4375}, -- support1 from front --right
			-- {-0.5, 0.375, -0.5, -0.25, 0.5, -0.375}, -- top rail
			-- {-0.1875, -0.5, -0.5, -0.125, 0.125, -0.4375}, -- support2 from front
			-- {-0.25, 0.125, -0.5, 0.0, 0.25, -0.375}, -- top rail
			-- {0.0625, -0.75, -0.5, 0.125, -0.125, -0.4375}, -- support3 from front
			-- {0.0, -0.125, -0.5, 0.25, 0.0, -0.375}, -- top rail
			-- {0.3125, -1.0, -0.5, 0.375, -0.375, -0.4375}, -- support4 from front
			-- {0.25, -0.375, -0.5, 0.5, -0.25, -0.375}, -- top rail
			{0.4375, -0.5, 0.3125, 0.5, 0.375, 0.375}, -- support1 from front --left
			{0.375, 0.375, 0.5, 0.5, 0.5, 0.25}, -- top rail
			{0.4375, -0.75, 0.0625, 0.5, 0.125, 0.125}, -- support2 from front
			{0.375, 0.125, 0.25, 0.5, 0.25, 0.0}, -- top rail
			{0.4375, -1.0, -0.1875, 0.5, -0.125, -0.125}, -- support3 from front
			{0.375, -0.125, 0.0, 0.5, 0.0, -0.25}, -- top rail
			{0.4375, -1.25, -0.4375, 0.5, -0.375, -0.375}, -- support4 from front
			{0.375, -0.375, -0.25, 0.5, -0.25, -0.5}, -- top rail
			{-0.5, -0.5, 0.3125, -0.4375, 0.375, 0.375}, -- support1 from front --right
			{-0.5, 0.375, 0.5, -0.375, 0.5, 0.25}, -- top rail
			{-0.5, -0.75, 0.0625, -0.4375, 0.125, 0.125}, -- support2 from front
			{-0.5, 0.125, 0.25, -0.375, 0.25, 0.0}, -- top rail
			{-0.5, -1.0, -0.1875, -0.4375, -0.125, -0.125}, -- support3 from front
			{-0.5, -0.125, 0.0, -0.375, 0.0, -0.25}, -- top rail
			{-0.5, -1.25, -0.4375, -0.4375, -0.375, -0.375}, -- support4 from front
			{-0.5, -0.375, -0.25, -0.375, -0.25, -0.5}, -- top rail
		},
	},
	selection_box = {
		type = "fixed",
...
gal.lib.shapes.register_shape("handrail_stairs_left", {
	description = S("Handrail Stairs - Left"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
	...
	selection_box = {
		type = "fixed",
		fixed = {
			{-0.4375, -0.25, 0.4375, -0.375, 0.375, 0.5}, -- support1 from front
			{-0.5, 0.375, 0.375, -0.25, 0.5, 0.5}, -- top rail
			{-0.1875, -0.5, 0.4375, -0.125, 0.125, 0.5}, -- support2 from front
			{-0.25, 0.125, 0.375, 0.0, 0.25, 0.5}, -- top rail
			{0.0625, -0.75, 0.4375, 0.125, -0.125, 0.5}, -- support3 from front
...
gal.lib.shapes.register_shape("handrail_stairs_right", {
	description = S("Handrail Stairs - Right"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
			{-0.4375, -1.0, 0.4375, -0.375, -0.375, 0.5}, -- support1 from front  --right
			{-0.5, -0.375, 0.375, -0.25, -0.25, 0.5}, -- top rail
			{-0.1875, -0.75, 0.4375, -0.125, -0.125, 0.5}, -- support2 from front
			{-0.25, -0.125, 0.375, 0.0, 0.0, 0.5}, -- top rail
			{0.0625, -0.5, 0.4375, 0.125, 0.125, 0.5}, -- support3 from front
			{0.0, 0.125, 0.375, 0.25, 0.25, 0.5}, -- top rail
			{0.3125, -0.25, 0.4375, 0.375, 0.375, 0.5}, -- support4 from front
			{0.25, 0.375, 0.375, 0.5, 0.5, 0.5}, -- top rail
		},
	},
	selection_box = {
		type = "fixed",
		fixed = {
			{-0.4375, -1.0, 0.4375, -0.375, -0.375, 0.5}, -- support1 from front
			{-0.5, -0.375, 0.375, -0.25, -0.25, 0.5}, -- top rail
			{-0.1875, -0.75, 0.4375, -0.125, -0.125, 0.5}, -- support2 from front
			{-0.25, -0.125, 0.375, 0.0, 0.0, 0.5}, -- top rail
			{0.0625, -0.5, 0.4375, 0.125, 0.125, 0.5}, -- support3 from front
...
gal.lib.shapes.register_shape("handrail_post", {
	description = S("Handrail Post"), 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
